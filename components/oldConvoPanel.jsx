...
const ChatPage = () => {
  ...
  const FileIndicator = () =>
    selectedFile && (
      <div className="flex items-center gap-2 mt-2 p-2 bg-gray-100 dark:bg-zinc-700 rounded">
  ...
  const handleSendMessage = async () => {
    ...
    try {
      // const convId = conversation?._id || await createNewConversation()
      ...
      formData.append("textContent", message); // Always send text
            ...
            <ul>
              ...
              {messages.length > 0 ? (
                messages.map((msg, index) => (
                  <Message
                    message={msg}
                    selectedAIContact={selectedAIContact}
                    user={user}
                  />
                ))
              ) : (
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex  gap-2">
                <input
                  ...
                  placeholder={
                    selectedFile ? "Add message..." : "Enter Message..."
                  }
                />
                ...
                <ul className="flex gap-2">
                  ...
                  {/* Attachment button with active state */}
                  <li>
                    <button
                      ...
                      disabled={!!selectedFile} // Disable when file selected
                    >
                  ...
                  <li>
                    <button
                      ...
                      disabled={
                        !message.trim() || (selectedFile && !message.trim())
                      }
                    >
